...
class Tpl {
     ...
     * @param bool $merge true to merge variable with existing one, false to append (default)
     *
     * @return \Rain\Tpl $this
     */
    public function assign($variable, $value = null, $merge = false) {
        if (is_array($variable)) {
            if ($merge)
                $this->var = array_merge_recursive($this->var, $variable);
            else
    ...
    protected function checkTemplate($template) {
        ...
        foreach($templateDirectories as $templateDirectory) {
            $templateDirectory = $templateBasedir !== null ? $templateBasedir : $templateDirectory;
