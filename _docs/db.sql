...
INSERT INTO `m_user` (`user_id`, `user_login`, `user_password`, `user_session_id`, `user_role_id`, `create_date`) VALUES (UUID_TO_BIN(@m_user__uuid), 'admin', '$2y$10$qhzTfZSHuM5WImS4.GfIUeho1/QuwREylM3DC9VKpxLK2WLZaxmpW', NULL, UUID_TO_BIN(@m_user_role__uuid), NOW());
